...
PM_START_TEXT = """
Hello, I'M Offtopic Manager Bot
`ɪ'ᴍ ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘꜱ! ʜɪᴛ` /help
Maintained by @Jai_Hindutva ❤
"""
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="ꜰᴇᴅᴇʀᴀᴛɪᴏɴ", url=f"https://t.me/offtopichatgroup"
        ),
    ],
    [
...
Powered by :- [Jai Hindutva](t.me/Jai_Hindutva)"""

layla_IMG = "https://telegra.ph/file/92ad54793fd5b0891fd0e.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [Hero](t.me/Jai_Hindutva) \
 Supporting isnt always financial! [OFFTOPIC CHAT](t.me/offtopichatgroup) \
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Offtopic Manager Bot*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ Support Group @offtopichatgroup
                 \n❍ Assistant @Jai_Hindutva
                 \nHere is the [💾Repository](https://github.com/QueenArzoo/LaylaRobot).
                 \n\nIf you have any question about Offtopic Manager Bot, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Offtopic Manager Bot*
